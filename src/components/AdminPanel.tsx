...
// is_ladder_admin) і діють на НАСТУПНІ забіги. Плюс новий сезон (обнулення ладдера).
// =========================================================
...
export default function AdminPanel({
  ...
  const doResetBoard = () => {
    if (!confirm('Обнулити ладдер (новий сезон)? Записи ладдера зникнуть, поточні забіги всіх гравців закриються без запису, лічильники забігів обнуляться. Історія забігів лишиться в базі. Дію не скасувати.')) return;
    setBusy(true);
