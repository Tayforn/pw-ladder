      ...
      <div className="modal" role="dialog" aria-modal="true" style={{ width: 'min(520px, 100%)' }}>
        ...
        <div className="modal-body" style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <p style={{ margin: 0 }}>
            ...
            той, хто дійшов до нього за <b>меншу кількість спроб</b> (бали на місце не впливають —
            їх можна нескінченно накрутити). Тисни «Внести в ладдер» коли завгодно: результат
